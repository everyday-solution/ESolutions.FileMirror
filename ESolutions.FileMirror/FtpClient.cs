	...
	public class FtpClient
	{
		...
		public bool Login()
		{
			...
			try
			{
				...
				address = Dns.GetHostEntry(this.server).AddressList[0];
		...
		/// <summary>
		/// Move a file to the ftp host, that means upload and delete the file afterwards.
		/// </summary>
		...
		private void readResponse()
		{
			...
			{
				throw new FtpException ("Connection closed by remote socket", ex);
			}
		}
...
*/
		...
		private delegate void MoveCallback (String fileName);
		public System.IAsyncResult BeginMove (String fileName, System.AsyncCallback callback)
		{
			MoveCallback ftpCallback = new MoveCallback (this.Move);
			return ftpCallback.BeginInvoke (fileName, callback, null);
		}
